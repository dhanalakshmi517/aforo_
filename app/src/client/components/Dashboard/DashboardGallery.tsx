...
type Props = {
  ...
  onCardClick?: (card: DashboardCardItem) => void;
...
const defaultCards: DashboardCardItem[] = [
  {
    id: "cust",
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="19" viewBox="0 0 16 19" fill="none">
        <path d="M6 1H9.33333M7.66667 11L10.1667 8.5M14.3333 11C14.3333 14.6819 11.3486 17.6667 7.66667 17.6667C3.98477 17.6667 1 14.6819 1 11C1 7.3181 3.98477 4.33333 7.66667 4.33333C11.3486 4.33333 14.3333 7.3181 14.3333 11Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
];
...
const DashboardGallery: React.FC<Props> = ({
  ...
  const handleCardClick = (card: DashboardCardItem) => {
    ...
    if (card.id === "cust") navigate("/get-started/dashboards/customer-analysis");
    else if (card.id === "realtime") navigate("/get-started/dashboards/real-time-tracking");
    else if (card.id === "product") navigate("/get-started/dashboards/product-analysis");
    else if (card.id === "revenue") navigate("/get-started/dashboards/revenue-analysis");
  };

  return (
    <div className="dgPage">
      <DashBoardHeader
        title="Dashboards"
