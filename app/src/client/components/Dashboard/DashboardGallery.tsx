        ...
        <div className="dg-actions">
          <button className="dg-icon-btn" aria-label="Add">
            <svg
              ...
              fill="none"
            >
              <g clipPath="url(#clip0_12503_17352)">
                <path
          ...
          <button className="dg-icon-btn" aria-label="Notifications">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
        ...
        {cards.map((c) => (
          ...
          >
            <div className="dg-media">
              ...
              {c.icon && <div className="dg-corner">{c.icon}</div>}
            </div>

            <div className="dg-meta">
              <div className="dg-title-row">
                <h3 className="dg-card-title">{c.title}</h3>
                {c.live && <span className="dg-live-badge">LIVE</span>}
              </div>
