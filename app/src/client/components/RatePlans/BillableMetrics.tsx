...
interface BillableMetricsProps {
  onSkip: () => void;
}

const BillableMetrics: React.FC<BillableMetricsProps> = ({ onSkip }) => {
    ...
    <div className="metrics-wrapper">
      ...
      {/* <div className="metric-box"> */}
        ...
        <div style={{ marginTop: '1rem' }}>
          <button className="button-secondary" onClick={onSkip}>Skip & Next</button>
        </div>
      </div>
  );
};
