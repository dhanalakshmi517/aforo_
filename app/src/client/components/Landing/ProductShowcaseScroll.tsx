...
const TriangleA = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 58 61" fill="none" xmlns="http://www.w3.org/2000/svg" width={58} height={61} {...props}>
    <path
      d="M20.3979 49.9332C13.9546 48.8344 10.733 48.285 10.021 46.0486C9.30893 43.8122 11.6199 41.5013 16.2417 36.8794L35.6342 17.4869C40.6964 12.4248 43.2274 9.89372 45.5365 10.7357C47.8456 11.5776 48.1535 15.1438 48.7692 22.2762L50.7582 45.3152C51.1529 49.8867 51.3502 52.1725 49.9572 53.4546C48.5642 54.7368 46.3026 54.3511 41.7794 53.5797L20.3979 49.9332Z"
      stroke="url(#g1)"
      strokeWidth="1.99348"
    />
    <path
      opacity="0.3"
      d="M14.7026 44.2379C8.25932 43.1391 5.0377 42.5897 4.32566 40.3533C3.61362 38.1169 5.92455 35.806 10.5464 31.1841L29.9389 11.7916C35.001 6.72947 37.5321 4.1984 39.8412 5.04034C42.1503 5.88229 42.4582 9.44849 43.0739 16.5809L45.0629 39.6199C45.4575 44.1914 45.6549 46.4772 44.2619 47.7593C42.8689 49.0415 40.6073 48.6558 36.0841 47.8844L14.7026 44.2379Z"
      stroke="url(#g2)"
      strokeWidth="1.99348"
    />
    <defs>
      <linearGradient id="g1" x1="28.6559" y1="5.776" x2="28.6559" y2="55.257" gradientUnits="userSpaceOnUse">
        <stop stopColor="#C4E9F9" />
...
const TriangleB = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="58" height="62" viewBox="0 0 58 62" fill="none" {...props}>
    <path
      d="M20.3979 50.2008C13.9546 49.102 10.733 48.5525 10.021 46.3162C9.30893 44.0798 11.6199 41.7689 16.2417 37.147L35.6342 17.7545C40.6964 12.6924 43.2274 10.1613 45.5365 11.0032C47.8456 11.8452 48.1535 15.4114 48.7692 22.5438L50.7582 45.5828C51.1529 50.1543 51.3502 52.4401 49.9572 53.7222C48.5642 55.0044 46.3026 54.6187 41.7794 53.8473L20.3979 50.2008Z"
      stroke="url(#paint0_linear_9219_9933)"
      strokeWidth="1.99348"
    />
    <path
      opacity="0.3"
      d="M14.7026 44.5055C8.25932 43.4067 5.0377 42.8572 4.32566 40.6208C3.61362 38.3845 5.92455 36.0735 10.5464 31.4517L29.9389 12.0592C35.001 6.99704 37.5321 4.46598 39.8412 5.30792C42.1503 6.14986 42.4582 9.71606 43.0739 16.8485L45.0629 39.8874C45.4575 44.459 45.6549 46.7447 44.2619 48.0269C42.8689 49.3091 40.6073 48.9234 36.0841 48.152L14.7026 44.5055Z"
      stroke="url(#paint1_linear_9219_9933)"
      strokeWidth="1.99348"
    />
    <defs>
...
type Slide = {
  ...
  art: string;
  left: LeftItem[];
  blurbTitle: string;     // desktop right text
  blurbLines: string[];
  mobileCopy: string;     // mobile bottom-left text
};

const ICON = { A: TriangleA, B: TriangleB, C: TriangleC } as const;
...
const SLIDES: Slide[] = [
...

  {
    ...
    art: billable,
    left: [
      { icon: "A", title: "Billable units\nturn raw activity\ninto revenue.", lines: [""] },
      { icon: "A", title: "Define what\ncounts—API\ncalls, seats, or\nstorage—and bill\nwith precision.", lines: [""] }
    ],
    blurbTitle:
      "The smallest measurable piece of usage.\nMinutes, requests, users—anything you can meter.",
    blurbLines: [],
    mobileCopy:
      "The smallest\nmeasurable piece\nof usage. Minutes,\nrequests, users—\nanything you can\nmeter."
  },

  {
    ...
    art: rateplan,
    left: [
      { icon: "A", title: "Rate plans adapt\nyour product to\ncustomer needs.", lines: [""] },
      { icon: "A", title: "Design Flexible\nPricing", lines: [""] },
      { icon: "C", title: "Experiment, iterate, and\nlaunch models that\nscale with your\nbusiness.", lines: [""] }
    ],
    blurbTitle:
      "Pricing logic for your product.\nFlat fee, pay-as-you-go, or custom tiers.",
    blurbLines: [],
    mobileCopy:
      "Pricing logic for\nyour product. Flat\nfee, pay-as-you-go,\nor custom tiers."
  },

  {
    ...
    art: landcustomer,
    left: [
      { icon: "A", title: "Centralize Customer Management", lines: [""] },
      { icon: "A", title: "From sign-up to\nbilling, keep every customer\nrecord organized.", lines: [""] },
      { icon: "C", title: "Track usage,payments,\nand relationships\nseamlessly.", lines: [""] }
    ],
    blurbTitle:
      "The people or businesses you bill.\nManage their accounts, history, and invoices in one place.",
    blurbLines: [],
    mobileCopy:
      "The people or\nbusinesses you bill.\nManage their\naccounts, history,\nand invoices in one\nplace."
  },

  {
    ...
    art: purchase,
    left: [
      { icon: "A", title: "Capture Every Purchase", lines: [""] },
    ...
    blurbTitle:
      "A customer’s subscription or contract.\nThe link between your product, pricing, and billing.",
    blurbLines: [],
    mobileCopy:
      "A customer’s\nsubscription or\ncontract. The link\nbetween your\nproduct, pricing,\nand billing."
  },

  {
    ...
    art: sitebuilder,
    left: [
      { icon: "A", title: "Sell With Zero Friction", lines: [""] },
      { icon: "A", title: "Launch a branded\nsales site without\ncode.", lines: [""] },
      { icon: "C", title: "Let customers\nbrowse,subscribe,\npay—all in one place.", lines: [""] }
    ],
    blurbTitle:
      "No-code storefront for your services.\nCreate, customize, and launch a sales-ready site instantly.",
    blurbLines: [],
    mobileCopy:
      "No-code storefront for\nyour services. Create,\ncustomize, and\nlaunch a sales-ready\nsite instantly."
  }
];

type SlideVis = { ratio: number; isIntersecting: boolean };
...
export default function ProductShowcaseScroll() {
  ...
  const visRef = useRef<Record<number, SlideVis>>({});
  ...
  useEffect(() => {
    const rootEl = viewportRef.current ?? null;
    if (!rootEl) return;
      ...
      (entries) => {
        entries.forEach((e) => {
          ...
          visRef.current[idx] = {
            ...
            isIntersecting: e.isIntersecting && (e.intersectionRatio ?? 0) > 0
          };
        });
        ...
        Object.entries(visRef.current).forEach(([k, v]) => {
          const idx = Number(k);
        ...
        if (bestIdx !== activeRef.current) setActive(bestIdx);
      },
      {
        root: rootEl,
        threshold: isMobile ? [0.55, 0.7, 0.85] : [0.6],
        rootMargin: "0px"
      }
    );
      ...
      <div className="ph__container">
          ...
          {SLIDES.map((s, idx) => (
            ...
            >
              <main className="ph__center">
                ...
                {/* MOBILE ONLY: bottom text + step */}
                <div className="phm__bottom" aria-hidden={false}>
                  <p className="phm__copy">{s.mobileCopy}</p>

                  <div className="phm__meta">
                    <span className="phm__stepNum">{s.step}</span>

                    <div className="phm__ticks" aria-hidden="true">
                      {SLIDES.map((_, tickIdx) => (
                        <svg
                          key={tickIdx}
                          xmlns="http://www.w3.org/2000/svg"
                          width={tickIdx === active ? "16" : "14"}
                          height={tickIdx === active ? "5" : "3"}
                          viewBox={tickIdx === active ? "0 0 16 5" : "0 0 14 3"}
                          fill="none"
                        >
                          <path
                            d={tickIdx === active ? "M2.2 2.5H13.8" : "M1.6 1.5H12.4"}
                            stroke={tickIdx === active ? "#025A94" : "#B0CBEE"}
                            strokeWidth={tickIdx === active ? "3.2" : "1.4"}
                            strokeLinecap="round"
                          />
                        </svg>
                      ))}
        ...
        <aside className="ph__right">
          <div className="ph__blurb">
            ...
            {currentSlide.blurbLines.map((l, i) => (
              <p className="ph__blurbLine" key={i}>
                {l}
              </p>
            ))}
          </div>
