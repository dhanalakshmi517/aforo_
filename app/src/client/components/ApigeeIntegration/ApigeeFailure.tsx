            ...
            <div className="sidebar-item failed">
              <div className="sidebar-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                  <path d="M12.5 3.75L6.25 10L2.5 6.25" stroke="#E53935" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
        ...
        <div className="success-main">
          <div className="failure-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
              <path d="M50 0C22.4 0 0 22.4 0 50C0 77.6 22.4 100 50 100C77.6 100 100 77.6 100 50C100 22.4 77.6 0 50 0ZM75 65.6L65.6 75L50 59.4L34.4 75L25 65.6L40.6 50L25 34.4L34.4 25L50 40.6L65.6 25L75 34.4L59.4 50L75 65.6Z" fill="#E53935"/>
            </svg>
          </div>
