...
const ApigeeIntegration: React.FC = () => {
  ...
  const [activeField, setActiveField] = useState<'orgId' | 'environment' | 'json' | null>(null);

  const handleBackClick = () => {
    navigate('/get-started/integrations');
  };

  const handleConnectApigee = () => {
    // Simulate connection attempt - for demo purposes, randomly show success or failure
    // In real implementation, this would be based on actual API response
    const isSuccess = Math.random() > 0.5; // 50% chance of success/failure for demo
          ...
          <div className="main-content-wrapper">
            ...
            <div className="connection-section">
              ...
              <div className="connection-form">
                ...
                <div className="form-field">
                  <label className="form-label">Enter Environment</label>
                  <input 
                    type="text" 
                    className="form-input" 
                ...
                <div className="form-field">
                  ...
                  <div className="file-upload-wrapper">
                    ...
                    />
                    <button className="upload-btn-integrated">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <path d="M7 1.75V8.75M7 1.75L9.91667 4.66667M7 1.75L4.08333 4.66667M12.25 8.75V11.0833C12.25 11.3928 12.1271 11.6895 11.9083 11.9083C11.6895 12.1271 11.3928 12.25 11.0833 12.25H2.91667C2.60725 12.25 2.3105 12.1271 2.09171 11.9083C1.87292 11.6895 1.75 11.3928 1.75 11.0833V8.75" stroke="#004B80" strokeWidth="0.88" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      Upload
                    </button>
                  </div>
                  <div className="file-info-external">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="8" cy="8" r="7" stroke="#0EA5E9" strokeWidth="1.33333"/>
                      <path d="M8 11.3333V8" stroke="#0EA5E9" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M8 5.33334H8.00667" stroke="#0EA5E9" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                ...
                {/* Connect Button */}
                <button className="connect-btn" onClick={handleConnectApigee}>
                  Connect Apigee
                </button>
              </div>
            </div>
              ...
              <div className="info-card-section">
                <div className="info-card">
                  <div className="info-card-header">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="8" cy="8" r="7" stroke="#0262A1" strokeWidth="1.33333"/>
                      <path d="M8 11.3333V8" stroke="#0262A1" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M8 5.33334H8.00667" stroke="#0262A1" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    <span className="info-card-title">
                      {activeField === 'orgId' ? 'How to Enter Apigee Org ID' : 
                       activeField === 'environment' ? 'How to Enter Environment' : 
                  ...
                  <div className="info-card-content">
                    <div 
                      ...
                      style={{
                        backgroundImage: `url(${
                          activeField === 'orgId' ? orgIdImage : 
                          activeField === 'environment' ? envImage : 
                          jsonImage
                        })`,
                        backgroundPosition: activeField === 'orgId' ? '-26.183px -21.054px' : 'center',
                        backgroundSize: activeField === 'orgId' ? '150.915% 160.769%' : 'cover',
                        backgroundRepeat: 'no-repeat'
                      }}
                    ></div>
                    ...
                    <div className="info-steps">
                      {activeField === 'orgId' ? (
                        <>
                          <p>Step 1: Click on the projects</p>
                          <p>Step 2: Copy the id of your project</p>
                          <p>Step 3: Paste the id in given input field.</p>
                        </>
