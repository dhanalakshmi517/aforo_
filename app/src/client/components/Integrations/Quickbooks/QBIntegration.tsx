...
type Props = {
  ...
  /** Right hero image (the QuickBooks mock). */
  heroSrc?: string;
  heroAlt?: string;

  /** Bottom-left marks */
  leftMarkSrc?: string;   // Aforo mark
  leftMarkAlt?: string;
  rightMarkSrc?: string;  // QuickBooks mark
  rightMarkAlt?: string;
  ...
  return (
    <div className={`qbint-page ${className}`}>
      ...
      <main className="qbint-main" role="main">
        <section className="qbint-card" aria-label="QuickBooks integration card">
...
function StarIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M12 3.6l2.55 5.18 5.71.83-4.13 4.03.98 5.7L12 16.8 6.89 19.34l.98-5.7L3.74 9.61l5.71-.83L12 3.6z"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinejoin="round"
      />
