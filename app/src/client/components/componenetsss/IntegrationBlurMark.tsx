// IntegrationBlurMark.tsx
import * as React from "react";
import GlassAforoTile from "./GlassAforoTile";
import GlassKongTile from "./GlassKongTile";
...
export default function IntegrationBlurMark({ className = "" }: Props) {
  return (
