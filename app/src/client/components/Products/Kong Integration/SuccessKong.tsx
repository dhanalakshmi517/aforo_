...
type SuccessKongProps = {
  onBack: () => void;

  title?: string; // default: "Connected To Kong"
  subtitle?: string;

  credentialsTitle?: string; // default: "KONG CREDENTIALS"
...
const SuccessKong: React.FC<SuccessKongProps> = ({
  onBack,
  title = "Connected To Kong",
  subtitle = "You are successfully connected to Kong. You can now import API\nproducts and manage them seamlessly.",
  credentialsTitle = "KONG CREDENTIALS",
  credentials,
  onDisconnect,
  onImportProducts,
...
function DisconnectIcon() {
  ...
  <g clip-path="url(#clip0_15609_26671)">
    <path d="M12.5597 8.88294L13.7063 7.64294H13.693C14.3068 6.95118 14.6431 6.02277 14.6281 5.06155C14.6131 4.10033 14.248 3.18487 13.613 2.51616C12.991 1.86367 12.1605 1.49906 11.2963 1.49906C10.4322 1.49906 9.60171 1.86367 8.97967 2.51616L7.83301 3.75616M3.44634 8.52037L2.30634 9.76037C1.69259 10.4521 1.35629 11.3805 1.37129 12.3418C1.38629 13.303 1.75136 14.2184 2.38634 14.8872C3.00838 15.5396 3.83885 15.9043 4.70301 15.9043C5.56717 15.9043 6.39764 15.5396 7.01967 14.8872L8.15967 13.6472M5.33301 1.4502V3.62563M1.33301 5.80107H3.33301M10.6663 13.7777V15.9531M12.6663 11.6022H14.6663" stroke="#ED5142" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
  <defs>
