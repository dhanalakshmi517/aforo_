...
const StairStep = forwardRef<StairStepHandle, StairStepProps>(
  ({ validationErrors = {}, onClearError, stairs: externalStairs, overageCharge: overageFromParent, graceBuffer: graceFromParent, onStairsChange, onOverageChange, onGraceBufferChange, locked = false }, ref) => {
