    ...
    <div className="volume-container">
      <div className="volume-input-section">
        <div className="stair-header-row">
          <div className="usage-range-label">Usage Volume Ranges</div>
          <div className="cost-label">Price per Unit</div>
        </div>

        {tiers.map((tier, index) => (
          <div className="volume-stair-row" key={index}>
            <input
              className="volume-input-small"
              value={tier.from}
            ...
            />
            <input
              className="volume-input-large"
              value={tier.price}
              onChange={(e) => handleChange(index, 'price', e.target.value)}
              placeholder="Price"
            />
            <button className="volume-delete-btn" onClick={() => handleDeleteTier(index)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <label className="volume-checkbox-label">
          <input
            type="checkbox"
            checked={unlimited}
            onChange={(e) => {
        ...
        <button className="volume-add-stair-btn" onClick={handleAddTier}>+ Add Volume Tier</button>
      </div>
  ...
  return (
    <div className="tiered-pricing-container">
      ...
      <p className="description">
        The consumer is charged according to the per-unit price corresponding to their total usage volume.
      </p>

      <div className="tiered-header">
        <span>Usage volume Ranges</span>
        <span></span>
