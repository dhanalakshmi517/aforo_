...
const EstimateRevenue: React.FC = () => {
  ...
  const flatFee = Number(getRatePlanData('FLAT_FEE_AMOUNT') || 0);
  const numberUnits = Number(getRatePlanData('FLAT_FEE_API_CALLS') || 0);
  const overageCharge = Number(getRatePlanData('FLAT_FEE_OVERAGE') || 0);
